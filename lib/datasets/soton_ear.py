...
import os
import lib.datasets.imdb as imdb
import numpy as np
import scipy.sparse
...
class soton_ear(datasets.imdb):
    def __init__(self, image_set, devkit_path=None):
        datasets.imdb.__init__(self, image_set)  # imageset Ϊtrain val trainval test
        self._image_set = image_set
        self._devkit_path = devkit_path
        self._data_path = os.path.join(self._devkit_path)
        self._classes = ('__background__', 'car')  # ��������
        self._class_to_ind = dict(
            zip(self.classes, xrange(self.num_classes)))  # �����ֵ�{'__background__':'0','car':'1'}
        # self._image_index = self._load_image_set_index('ImageList_Version_S.txt')#�����ļ��б�
        # self._image_index = self._load_image_set_index('ImageList_Version_S_window_List.txt')#�����ļ��б�
    ...
    def image_path_at(self, i):  # ����_image_index �±�Ϊi��ͼ����·��
        """
        Return the absolute path to image i in the image sequence.
        """
        return self.image_path_from_index(self._image_index[i])

    def image_path_from_index(self, index):  # ����_image_index��ȡͼ��·��
        """
    ...
    def _load_image_set_index(self, imagelist):  # �Ѿ��޸�
        """
    ...
    def gt_roidb(self):
        ...
        if os.path.exists(cache_file):  # ������cache file��ֱ�Ӵ�cache file�ж�ȡ
            with open(cache_file, 'rb') as fid:
                roidb = cPickle.load(fid)
            print '{} gt roidb loaded from {}'.format(self.name, cache_file)
            return roidb

        gt_roidb = self._load_annotation()  # �Ѿ��޸ģ�ֱ�Ӷ�������GT�ļ�
    ...
    def selective_search_roidb(self):  # �Ѿ��޸�
        """
        ...
        if os.path.exists(cache_file):  # ������cache_file����ȡ����Ӧ��.pkl�ļ�
            with open(cache_file, 'rb') as fid:
                roidb = cPickle.load(fid)
    ...
    def _load_selective_search_roidb(self, gt_roidb):  # �Ѿ��޸�
        # filename = os.path.abspath(os.path.join(self.cache_path, '..','selective_search_data',self.name + '.mat'))
        filename = os.path.join(self._data_path, 'EdgeBox_Version_S_AddData.mat')  # ������������Ӧ��Ԥѡ���ļ�·��
        ...
        for i in xrange(raw_data.shape[0]):
            # box_list.append(raw_data[i][:,(1, 0, 3, 2)] - 1)#ԭ����Psacalvoc�������У�������box��˳����x1 ,y1,x2,y2 ��EdgeBox��ʽΪx1,y1,w,h�����޸�
    ...
    def _load_annotation(self):
        ...
        format.
        """
        # ���˺������ö���GT�ļ����ҵ��ļ��ĸ�ʽ CarTrainingDataForFRCNN_1\Images\2015011100035366101A000131.jpg 1 147 65 443 361
        gt_roidb = []
